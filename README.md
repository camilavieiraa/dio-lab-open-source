...
GitHub Discussions é um fórum de comunicação colaborativo dentro do GitHub. Em Caso tenha dúvidas, você pode abrir uma discussão, dentro de uma categoria apropriada, na aba "Discussions" do repositório do projeto.
